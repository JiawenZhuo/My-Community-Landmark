...
function InfoSectionAtBottom({clickedLatLng,setclickedLatLng,setAddNote,handleSubmit,noteInput,userInput,setUserInput,setNoteInput,activeComments,addNote}) {
  return (
        <>
        {clickedLatLng && (
          <div
